# Route medication system changes through hospital governance
...
Route formulary, ADC, EHR, and compounding changes through documented governance with downtime rollback (C13-006 held design).

## Who should use it / who else to involve
Informatics pharmacist; P&T chair; nursing informatics; IT change board.
...
1. Intake → risk tier (L1 process / L2 safety / L3 legal-license).  
2. Impact analysis: pharmacy, nursing, providers, IT, EP.  
3. Approvals: pharmacy leadership → P&T/med exec as required by bylaws → IT CAB.  
4. Synthetic pilot on non-production.  
5. Go-live with rollback owner and communication script.  
6. Post-implementation review ≤30 days.

Exception path: urgent safety fix with retrospective committee notice per local policy.
