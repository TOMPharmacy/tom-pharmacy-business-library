# Make a case for a hospital pharmacy service change
...
**Not:** guaranteed ROI or FTEs as national facts

## What this helps you decide or do
Estimate capacity, capital, and risk for a proposed change (e.g., ADC expansion, decentralized pharmacist, overnight remote verify) using local data. Cite ASHP surveys only as external context [7][9].

## Who should use it / who else to involve
Pharmacy director; CFO liaison; nursing; IT; HR.
...
## Core content
### A. Problem statement (synthetic)
“Night verify lag p90 = 48 min on *Unit Zebra*; nursing escalations 22/mo.”

### B. Options table
| Option | One-time $ | Annual $ | Risk notes | Dependencies |
|--------|------------|----------|------------|--------------|
| Status quo | 0 | | | |
| Add FTE verify | | | Workforce shortage context [9] | Recruit |
| Tech workflow change | | | Downtime plan | IT + P&T |
| Hybrid remote verify | | | Class C on-site rules [2] | Counsel |

### C. Sensitivity
±20% volume; delayed go-live 90 days; failed interface.
