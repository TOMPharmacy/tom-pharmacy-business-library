# Hospital pharmacy authority and governance evidence
...
Separate CoP, state board, DEA, medical-staff, and policy authorities. Reference-only; no accreditation copying.

## Who should use it / who else to involve
Compliance; pharmacy director; counsel; medical staff office.
...
## Core content
| Authority layer | Example duty | Source orientation | Evidence |
|-----------------|--------------|--------------------|----------|
| CMS CoP | Pharmaceutical services meeting needs [1] | §482.25 | Survey readiness file |
| Texas Class C | Supervision / PIC [2] | TSBP May24 | License |
| DEA | Effective CS controls [3] | 21 CFR 1301.71 | Perpetual / audits |
| Medical staff | Formulary / privileges | Bylaws (local) | Minutes |
| EP | Continuity roles [4] | CMS EP Rule | EP plan annex |

Unresolved questions log required for any blank cell before go-live of high-risk changes.
