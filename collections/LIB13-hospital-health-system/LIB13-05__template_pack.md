# Hospital pharmacy committee and exception tools
...
Blank agendas and exception forms for P&T/pharmacy ops committees. Synthetic IDs only.

## Who should use it / who else to involve
Committee coordinator; pharmacy director; quality.
...
## Core content
### A. P&T agenda skeleton
| Item | Owner | Decision needed | Follow-up |
|------|-------|-----------------|-----------|
| Formulary add (synthetic) | | | |
| Shortage mitigation | | | |
| Diversion metric review | | | |

### B. Exception / downtime ticket
| Field | Entry |
|-------|-------|
| System | ADC / EHR / IV workflow |
| Start–end | |
| Manual process used | |
