# Build an internal service agreement with care teams
...
Define pharmacy and partner-department deliverables (ED, ICU, oncology) as an internal service-level discussion — not a vendor sales pitch.

## Who should use it / who else to involve
Pharmacy director; service-line chief; nursing director; quality.
...
## Core content
### Discussion brief
| Deliverable | Pharmacy commits | Partner commits | Measure |
|-------------|------------------|-----------------|---------|
| Order turnaround | p90 target | Complete orders | Dashboard |
| Shortage comms | Same-day notice | Cascade to staff | Log |
| Diversion cooperation | Timely ADC audits | Witness counts | Committee |

Onboarding plan for new unit; joint review agenda quarterly. No exclusivity or outcome warranties.
