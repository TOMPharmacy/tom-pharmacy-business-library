# A hospital pharmacy performance and risk review
...
Connect supply, safety, and improvement measures to institutional decisions without claiming outcome guarantees.

## Who should use it / who else to involve
Pharmacy leadership; quality; med safety officer; C-suite liaison.
...
|---------|------------|----------------|
| Verify turnaround p90 | Order ready→verify | Weekly ops |
| ADC stock-out rate | | Monthly |
| Controlled discrepancy open >72h | | Weekly diversion |
| Shortage active SKUs | | Weekly |
| EP drill pharmacy participation | | Per EP calendar [4] |

Action-effectiveness: each CAPA needs dated check and committee report.
