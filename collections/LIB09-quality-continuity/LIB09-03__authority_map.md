# Which quality reporting and preparedness rules apply
...
**Not:** accreditation manual republication or survey coaching guaranteeing pass
...
Separate setting-specific requirements, state rules, and voluntary guidance. Reference-only matrix.

## Who should use it / who else to involve
Quality lead; counsel; facility compliance if Medicare ASC/hospital.
...
|----------|---------|------------|
| Medicare/Medicaid participating ASC/hospital/CAH (or pharmacy as department)? | CMS EP four core elements | [1][2][3] |
| Stand-alone community pharmacy only? | EP Rule generally **not** applicable; consider voluntary COOP | [3] |
| Systems contain ePHI? | HIPAA Security contingency | [5] |
| DEA registrant? | Theft/loss reporting clock | [6] |
| Texas Class C? | EP plan in P&P; ADC recovery plan + Board notice triggers | [7] |
| Dispenser under DSCSA? | Suspect product as quality incident | [8] |
| Want CQI taxonomy? | NCC MERP index + dispensing recommendations; ISMP education hub | [9][10][11] |
| Claiming TX mandatory CQI? | **STOP** — verify board text; national variation [13] | Held pending |
