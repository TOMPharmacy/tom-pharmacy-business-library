# Discuss quality with clients using verified evidence
...
**Not:** guaranteed survey outcomes, AKS advice, or patient solicitation
...
Present improvements and limitations to organizational clients (ASC admin, clinic quality) without compliance guarantees. Cite methods and your local data—not invented national ranks.

## Who should use it / who else to involve
Consultant pharmacist / quality lead; counsel for client-facing claims.
...
## Core content
### Continuity diagnostic offer (synthetic B2B)
Gap list vs CMS EP applicability branch [1][3]; Class C EP/ADC P&P check [7]; incident clock map (DEA/DSCSA) [6][8]; CQI taxonomy recommendation [9][10]. **Explicit:** no guaranteed survey pass.

### Client conversation guardrails
- Show **your** drill AAR and CAPA closure rates  
- Distinguish CMS EP must vs voluntary COM COOP [3]  
- Do not republish ISMP newsletters; link only [11]  
- No patient solicitation content (see LIB10 HELD)
