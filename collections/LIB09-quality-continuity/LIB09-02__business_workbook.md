# Fund resilience and improvement work
...
**Not:** actuarial loss models or guaranteed ROI on drills
...
Evaluate disruption exposure and resource needs with **local** assumptions. Fund drills, backup power, alternate suppliers, and quality staff time without inventing benchmarks.

## Who should use it / who else to involve
Owner + quality lead; PIC; facility EP lead if ASC.
...
## Core content
### A. Risk register (synthetic categories)
| Risk | Likelihood (L/M/H) | Impact (L/M/H) | Owner | Control | Residual |
|------|--------------------|----------------|------|---------|----------|
| Power outage | | | | Generator/UPS | |
| PMS downtime | | | | Auxiliary SOP [7] | |
| CS theft/loss | | | | Security + Form 106 path [6] | |
| Wholesaler outage | | | | Secondary ATP | |
| Cold-chain failure | | | | SPC sensors | |
| Staffing loss | | | | Call tree | |

### B. Business impact (blank $ / hours)
| Process | Max tolerable downtime | Revenue/Rx at risk / day | Notes |
|---------|------------------------|-------------------------|-------|
| Dispensing | | | COM |
| ASC case support | | | ASC |
| Specialty shipment | | | SPC |

### C. Resilience budget lines
| Item | Annual $ | Must / Should / Could | Cite / reason |
|------|----------|----------------------|---------------|
| EP/COOP drills | | | [2] or voluntary |
| Backup internet/power | | | |
| Quality analyst hours | | | [10][12] |
| Secondary wholesaler fees | | | |
