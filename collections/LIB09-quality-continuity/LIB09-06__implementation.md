# Run a pharmacy downtime and handoff exercise
...
**Not:** live disaster activation or public emergency messaging
...
Prepare teams for outages, absent staff, and supply disruption with tabletop or functional exercises. Synthetic scenarios only.

## Who should use it / who else to involve
PIC; quality; IT; facility EP coordinator (ASC); nursing (ASC floor stock).
...
## Core content
### RACI (example roles — rename locally)
| Activity | PIC | Owner | Quality | IT | Facility EP |
|----------|-----|-------|---------|----|-------------|
| Declare downtime | A/R | C | C | C | C |
| Auxiliary dispensing | R | I | C | C | I |
| DEA notice if diversion | A/R | I | C | I | I |
| EP communications | C | I | C | I | A/R |

### Exercise menu
1. PMS down at peak (COM) → auxiliary procedure [7] + HIPAA contingency restore [5].  
2. Missing C-II (any) → Form 106 clock tabletop [6].  
3. Suspect product (DSCSA) → quarantine path [8].  
4. ASC Medicare EP annual testing element — follow facility EP calendar [2].  
5. TEL: failover verification site unreachable → scripted patient/facility messaging (editorial).

### Acceptance evidence
Signed roster · timed objectives · AAR · CAPAs · updated COOP/EP annex.
