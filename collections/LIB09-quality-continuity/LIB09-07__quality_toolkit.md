# Measures that support decisions rather than scores
...
**Not:** arbitrary national score targets or public report cards with PHI
...
Choose reproducible safety, service, workload, and continuity indicators that drive actions—not vanity scores.

## Who should use it / who else to involve
Quality lead; PIC; owner (resource decisions).
...
## Core content
### Metric dictionary
| Domain | Example measure (define locally) | Action trigger |
|--------|----------------------------------|----------------|
| Safety | Near misses / 1000 Rx; NCC MERP A–I distribution [9] | Spike → huddle |
| Dispensing CQI | % events with completed CAPA ≤14 days | Aging CAPAs |
| Continuity | Unplanned downtime hours; drill completion | Missed annual review [2] |
| Diversion | Open CS variances >48h; Form 106 drills/year [6] | Immediate PIC review |
| Supply | Open recall/suspect tickets [8] | Daily until closed |
| Culture | Safety-attitude pulse (optional; see [12]) | Training plan |

### Drill calendar (template)
| Quarter | Exercise | Owner | Done |
|---------|----------|-------|------|
| Q1 | Downtime auxiliary | PIC | |
| Q2 | Form 106 tabletop | PIC | |
| Q3 | DSCSA suspect product | Inventory | |
| Q4 | EP/COOP full review | Quality / EP | |
