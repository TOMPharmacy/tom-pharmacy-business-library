# A quality system that improves everyday work
...
**Risk tier:** L1 (CQI culture) / L2 (EP applicability)  
**Version:** 0.3-final-draft  
**Last verified:** 2026-09-19  
**Not:** survey-outcome guarantee, legal advice, or mandatory CQI claim for Texas without primary board text
...
Connect incident learning, reliability, and management decisions. Separate **mandatory** CMS Emergency Preparedness duties for Medicare/Medicaid participating provider types [1] from **voluntary** continuity planning for stand-alone community pharmacies [3]. Build a CQI taxonomy with NCC MERP/ISMP frameworks [9][10][11] and wire DEA Form 106 [6] and DSCSA suspect-product events [8] into incident workflows.

## Who should use it / who else to involve
Quality lead + PIC; facility EP coordinator if ASC/hospital; counsel for L3 HIPAA contingency overlaps [5].
...
## Core content
### Applicability branch (critical)
- CMS EP Rule: national requirements for covered Medicare/Medicaid providers/suppliers [1].  
- Four core elements: risk assessment & emergency planning (plan reviewed/updated at least annually); policies & procedures; communication plan; training & testing [2].  
- FAQ: regulation does **not** apply to stand-alone community pharmacies; **does** apply to pharmacies that are departments of Medicare-participating facilities (hospital, ASC, CAH, etc.) [3].  
- Provider guidance points to ASPR TRACIE / Appendix Z resources [4].

### Always-on clocks (any setting with CS / ePHI / DSCSA)
- Theft/significant loss → Field Division ≤1 business day + Form 106 [6].  
- HIPAA contingency for systems with ePHI [5].  
- Suspect product quarantine/investigate [8].

### CQI evidence (practice)
NCC MERP recommends written SOPs and a fully implemented written CQI program to collect/analyze actual and potential dispensing errors [10]. Guided CQI improved safety-culture attitudes in a controlled evaluation (QRE reporting frequency did not significantly change) [12]. State board CQI requirements vary widely [13].
