# Your first community pharmacy service offer
...
Turn validated local needs into a clear, supportable offer — positioning, outreach draft, and claims-evidence review — without overclaiming payment, clinical outcomes, or compliance. Closure and access literature [18][19] may justify *why* a service matters locally; it does not prove *your* results in advance.

## Who should use it / who else to involve

Owner/BD drafts; PIC verifies service is inside license and staffing; counsel reviews inducement/advertising risk for outreach; privacy reviewer if using patient stories (prefer synthetic).
...
### Offer construction steps

1. Pull need statements from discovery templates.  
2. Map each promised service to class/DEA/staffing reality [1][7].  
3. Write exclusions as clearly as inclusions (e.g., “no sterile under Class A”) [1].  
4. Draft outreach; run claims–evidence checklist.  
5. Park payer-specific promises for LIB05.

### Synthetic outreach snippet (FICTIONAL clinic letter)

“We are preparing a Class A community pharmacy at [address pending license]. We can discuss hours and delivery options after licensure. We cannot promise network status or reimbursement rates in this letter.” — review by counsel before send.
