# Asset, access, and vendor decision records
...
**Not:** real credentials, production PHI, or live API keys in examples
...
Maintain practical evidence for systems, accounts, and external services—synthetic examples only in shared packs.

## Who should use it / who else to involve
Security official (custody); PIC; vendor manager.
...
| Criterion | Wt | Score 1–5 | Evidence |
|-----------|----|-----------|----------|
| Signed BAA | 5 | | [1] |
| Unique user ID + MFA | 5 | | |
| Audit log export | 5 | | |
| Encryption at rest/transit | 5 | | |
| RTO/RPO documented | 4 | | editorial tip |
| DSCSA / e-Rx modules | 3 | | COM SPC |
| Remote supervision privacy | 4 | | TEL |
| Exit/data return terms | 4 | | |

**Gate:** any score 1 on BAA, unique ID, or audit export → do not purchase.

### BAA checklist
- [ ] Permitted uses/disclosures
- [ ] Safeguards
- [ ] Subcontractor flow-down
- [ ] Breach/security incident reporting timelines [4]
- [ ] Termination / return / destroy PHI [1]

### Access review log (quarterly)
| User | Role | Systems | Last review | Remove? | Initials |
|------|------|---------|-------------|---------|----------|
| | | | | | |

### Retention matrix (orientation)
| Record type | Min retention orientation | Source |
|-------------|---------------------------|--------|
| Security policies & SRA docs | 6 years | [3] |
| CS inventories/records | Federal ≥2 years — confirm current 1304 | [5] |
| TX pharmacy DP backups / loss reports | VERIFY Class + board | [6] |

### Asset register (blank)
| Asset | Owner | Vendor | PHI? | BAA # | Criticality |
|-------|-------|--------|------|-------|-------------|
| | | | | | |
