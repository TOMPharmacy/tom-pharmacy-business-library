# Communicate shortages and service alternatives
...
**Not:** patient-solicitation playbook, AKS advice, or guaranteed fill-rate claims
...
Prepare accountable updates to organizational partners (ASC admin, clinic director, employer clinic lead) during supply problems—without inventing clinical outcomes or promising fills you cannot support. **B2B / facility communications only** in this pack.

## Who should use it / who else to involve
PIC or consultant pharmacist; account lead; counsel if communications approach marketing/solicitation boundaries (see LIB10 Topic 09 — Ch.102 / AKS **HELD**).

## How to use the companion tools
Use shortage brief with `LIB08-02` cash exposure; link CAPAs from `LIB08-07`. For ASC consulting sales motion, cross-link LIB11.

## Core content
### Synthetic B2B offer (fictional)
“2-week inventory-control diagnostic for ASC/clinic clients → gap list + 90-day CAPA plan.” Deliverables: receiving SOP gap table, perpetual C-II readiness, ATP log sample, Form 106 readiness packet (blank).

### Shortage / alternative communication canvas (organizational buyer)
| Element | Draft (synthetic) |
|---------|-------------------|
| What is unavailable | Drug/class (no PHI) |
| Why (known fact only) | Manufacturer allocation / wholesaler delay / recall |
| Patient-care impact channel | Facility clinical lead notified (not a clinical protocol) |
| Alternatives under review | Therapeutic interchange **requires** authorized prescriber process — pharmacy does not invent switches |
| Expected review date | |
| What we will not claim | Guaranteed restoration date; DEA “cleared”; 340B workaround |

### Do not sell / do not claim
- Guaranteed DEA or board inspection outcomes  
- 340B arbitrage or diversion schemes [12]  
- Patient cold-call solicitation or referral-fee arrangements (**HELD** — LIB10)  
- “DSCSA compliant certified” seals without vendor evidence  

### Partner update checklist
- [ ] Facts verified against wholesaler ticket / FDA recall notice  
- [ ] PIC approved wording  
- [ ] No PHI in email body to group lists  
- [ ] CAPA or purchasing action attached  
