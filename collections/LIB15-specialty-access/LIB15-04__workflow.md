# Referral benefits investigation and dispensing handoffs
...
Track access work without replacing current REMS instructions. Placeholders for product-specific qualified review.

## Who should use it / who else to involve
Access specialist; pharmacist verifier; shipment lead; clinic coordinator.
...
## Core content
1. **Referral intake** — demographics, Rx, diagnosis codes (as provided), urgency.  
2. **Benefits investigation** — pharmacy vs medical benefit; document result.  
3. **PA / appeals** — status board; no clinical fabrication.  
4. **REMS gate** — follow **current** FDA/sponsor checklist for that product [1][2].  
5. **Financial assistance** (optional) — separate from clinical eligibility.  
6. **Dispense / ship** — final product verification by pharmacist; cold-chain.  
7. **Handoff** — clinic notified; monitoring plan owner named.  
8. **Exception** — denial, REMS fail, network block → documented patient/clinic notice without promising alternatives you cannot fill.
