# Why specialty pharmacy services are different
...
**Risk tier:** L2 (model) / L3 (REMS/network)  
...
Map coordination dependencies — benefits investigation, prior authorization, limited distribution, REMS — **without promising network entry or therapy availability**. FDA REMS may impose pharmacy certification and documentation ETASU [1][2]. CMS Part D orientation limits specialty-tier-only network narrowing [3]. ASHP HSSP survey shows network restrictions remain a top challenge [4].

## Who should use it / who else to involve
Specialty leader; access team; REMS pharmacist; counsel; privacy.
...
## Core content — dependency map
| Dependency | Failure mode | Evidence needed |
|------------|--------------|-----------------|
| Benefits investigation | Wrong payer pathway | Coverage result + date |
| PA / medical necessity | Delay / denial | PA # / appeal status |
| REMS | Cannot dispense | Current portal enrollment [1][2] |
| Limited distribution | Not in network | Manufacturer notice (confidential) |
| Shipment / cold chain | Product loss | Temp logger |
| Counseling / monitoring | Incomplete start | Outreach log |

Synthetic example: *Drug Zeta* referral day 0 → BI day 2 → PA pending day 9 → REMS OK → ship day 12. No promise that day 12 is typical.
