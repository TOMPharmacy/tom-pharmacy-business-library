# Model access delays and specialty service costs
...
**Not:** guaranteed margins or float recovery

## What this helps you decide or do
Connect referral assumptions, product access, and labor effort to cash exposure. COGS float for high-cost drugs can dominate — use synthetic dollars only.

## Who should use it / who else to involve
Specialty finance; access manager; PIC; accountant.
...
## Core content
### A. Stage times (hours/days)
| Stage | Median | p90 | Owner |
|-------|--------|-----|-------|
| Intake complete | | | |
...
### B. Cost & float (synthetic $)
| Element | Assumption | Monthly impact |
|---------|------------|----------------|
| COGS float days | | |
| Labor per case | | |
...
### C. Scenarios
Network loss; REMS portal outage; PA backlog +50%.
