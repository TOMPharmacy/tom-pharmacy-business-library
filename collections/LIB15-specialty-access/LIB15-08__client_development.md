# Develop specialty referral relationships responsibly
...
Describe verified access capabilities to referrers **without promising therapy availability** or network acceptance.

## Who should use it / who else to involve
BD/account; counsel (marketing review); REMS pharmacist; clinic liaison.
...
## Core content
### Referrer factsheet sections
1. Services we perform (BI, PA support, REMS-capable dispensing when enrolled)  
2. Services we cannot promise (start date; LDN drugs not contracted)  
3. How to refer (synthetic checklist)  
4. Privacy  
5. Quality measures we share (process only)

### Capability-evidence review packet
License list; REMS enrollment attestations (product list without pasting REMS); sample redacted timeline; CMS Part D orientation citation for discussions [3] — not a substitute for plan contracts.
