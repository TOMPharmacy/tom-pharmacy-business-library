# Review time to access unresolved work and service quality
...
Surface delays and missing evidence with process measures (stage-split cycle times — C15-004 held design). No clinical outcome claims.

## Who should use it / who else to involve
Specialty ops; quality; clinic partners.
...
| Measure | Definition |
|---------|------------|
| Time-to-BI | Referral→BI complete |
| Time-to-PA decision | PA submit→decision |
| Time-to-REMS clear | |
| Time-to-ship | Ready→ship |
| Unresolved >14d | Open cases aging |
| REMS fail rate | Blocks / attempts |
| Network reject rate | |

Case-process learning: monthly review of longest quartile with redacted synthetic IDs.
