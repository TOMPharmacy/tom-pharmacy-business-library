# Access case and coordination planning tools
...
Capture operational status without embedding clinical protocols or REMS text.

## Who should use it / who else to involve
Access team; privacy; pharmacist.
...
## Core content
### Access checklist
| Gate | Done | Date | Evidence link |
|------|------|------|---------------|
| Intake complete | | | |
| BI complete | | | |
| PA status | | | |
| REMS current | | | Portal only |
| Ship ready | | | |

### Benefits evidence log
Payer | Plan ID (synthetic) | Result | Date | Agent ref

### Coordination handoff form
Clinic contact | Monitoring owner | Next lab/visit (as ordered by prescriber) | Pharmacy callback #
