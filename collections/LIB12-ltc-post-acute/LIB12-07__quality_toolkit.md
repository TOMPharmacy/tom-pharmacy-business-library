# Review facility pharmacy reliability and follow-through
...
Expose delivery reliability and DRR follow-through without claiming clinical effectiveness outcomes.

## Who should use it / who else to involve
Account lead; consultant; DON; quality committee.
...
## Core content — measure addendum
| Measure | Definition | Target style | Notes |
|---------|------------|--------------|-------|
| On-time cycle delivery | % by promised window | Local SLA | Not a CoP substitute |
| STAT median minutes | Order clear→arrive | Local | |
| DRR completion | Residents reviewed / census in month | ≥ monthly [1] | Facility+pharmacy shared view |
| Irregularity closure | % with MD documentation in X days | Local P&P | |
| Open urgent findings | Count aging > P&P limit | Zero tolerance locally | |

Action-effectiveness review: sample closed findings quarterly (synthetic chart IDs in drills).
