# Understand the long-term care pharmacy service network
...
**Risk tier:** L2 (model) / L3 (CoP shalls)  
...
Distinguish **facility pharmaceutical-service obligations**, **dispensing pharmacy operations**, and **consultant pharmacist drug-regimen review**. CMS §483.45 requires facilities to provide or obtain drugs, use a licensed pharmacist for consultation and monthly regimen review with chart review, and act on written irregularity reports [1]. Texas Class C overlays apply when the pharmacy is institutional Class C [3]. Do not invent therapy algorithms.

## Who should use it / who else to involve
LTC pharmacist; DON; medical director; pharmacy vendor account lead; counsel; privacy [6].
...
## Core content — service map
| Actor | Typical duties (orientation) | Controlling text orientation |
|-------|------------------------------|------------------------------|
| Facility | Routine/emergency meds; storage; med error rates; act on irregularities [1] | 42 CFR §483.45 |
| Dispensing pharmacy | Accurate acquire/dispense/label/delivery per contract & license | State board + contract |
| Consultant / DRR pharmacist | ≥ monthly regimen + chart review; separate written irregularity report [1] | §483.45(c) |
| Prescriber | Document review of irregularities; action or rationale [1] | §483.45(c)(4) |

### Psychotropic / PRN orientation (facility)
PRN psychotropic limits (14-day) and antipsychotic renewal evaluation rules sit in §483.45(e) — pharmacist reports irregularities; facility/prescriber own therapy decisions [1].
