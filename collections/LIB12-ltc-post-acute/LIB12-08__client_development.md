# Build a facility service proposal and renewal review
...
Propose dispensing + consultant support with clear exclusions and evidence needs. No survey-pass promises.

## Who should use it / who else to involve
Pharmacy BD; counsel; facility administrator; medical director.
...
### Proposal sections
1. Services in / out  
2. DRR cadence alignment to §483.45 monthly minimum [1]  
3. After-hours & STAT definitions  
4. Privacy/BAA [6]  
5. Quality measures from toolkit  
6. Renewal scorecard (delivery, DRR completion, open findings aging)

### Synthetic renewal line
“DRR completion 100% of census months; irregularity closure median 4 days; two courier misses — CAPA attached. We do not warrant survey results.”
